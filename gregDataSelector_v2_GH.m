...
indices_180 = find(All(ind).out.exp.ensPO==180)
All(ind).out.exp.ensMaxD(indices_180);

% indices_90 = find(All(ind).out.exp.ensPO==270)
% All(ind).out.exp.ensMaxD(indices_90)
