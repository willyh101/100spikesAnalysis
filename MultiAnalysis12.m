...
[All, outVars] = getTuningCurve12(All, opts, outVars);
[All, outVars] = calcOSI_12(All, outVars);
[All, outVars] = calcTuningCircular_12(All, outVars); % note: only works on tuned cells (ie. not for max of visID=1)
[All, outVars] = getEnsembleOSI_12(All, outVars); % for ensembles specifically
%% plot vis things
...
[All, outVars] = compareAllCellsTuning_12(All, outVars, opts);
opts.posModOnly = 0;
[outVars] = getRespByTuningDiff_12(All, outVars, opts);
...
plotResponseByDifferenceinAnglePref_12(outVars, opts)
...
%%
plotResponseByDiffAnglePrefPosNeg_12(outVars,opts);
...
[outVars] = getRespByTuningDiffNotRed_12(All, outVars);
[outVars] = getRespByTuningDiffRed_12(All, outVars);
%%
opts.goodOSIthresh = 0.5;
plotResponseByDifferenceinAnglePrefRed_12(outVars, opts)
%%
