function plotComparePyrCellScatter(outVars)
...
order = 1:numel(ensemblesToUse(ensemblesToUse==1));
...
ensemblesToUse = outVars.ensemblesToUse;
popRespCoTuned = outVars.isoEnsResp(ensemblesToUse);
popRespOrthoTuned = outVars.orthoEnsResp(ensemblesToUse);
popRespNotCoTuned = outVars.notCoTunedResp(ensemblesToUse);
popRespNotVisResp = outVars.notVisEnsResp(ensemblesToUse);
