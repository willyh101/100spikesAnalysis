...
%%
function Fig5bc_v2(cellTable,cellCond,cellCondTuned,cellCondNonVis,cellCondNonTuned)
...
%% relative fraction of cells by condition
percentOfCells = zeros(2,num_conds);
for jj = 1:2
    ...
    for gg = 1:num_conds
        ...
        if gg < 5
            cellSelector =  ensSelectorTuning & ensSelectorSpread ...
                & cellSelectorOri(:,gg) & cellCondTuned;
        elseif gg==5
            cellSelector = ensSelectorTuning & ensSelectorSpread ...
                & cellCondNonVis;
        ...
        cellSelectAll = ensSelectorTuning & ensSelectorSpread ...
                & cellCond;
            
        percentOfCells(jj,gg) = sum(cellSelector) / sum(cellSelectAll); 
    end
...
colorScheme(5,:) = [0.5 0.5 0.5];
titles={'Iso','45','Ortho' 'non-vis' 'non-tuned'};
indicesToPlot = [1 2 3 5 6];
