...
%GREG LOOK AT THIS
clearvars dataForStats
% opts.distType = 'harm'; 
% opts.distBins =[0:50:400];

opts.distType = 'conn dist';
opts.distBins =[0:0.5:6 inf];% [0:25:400];
...
for i = 1:numel(bins2)-1
    for k = 1:numel(bins)-1
        ...
        if strcmp(opts.distType,'conn dist')
            xlabel('~K (# of connections)')
        end
