...
opts.sparseAlgo = 'popKurtosis';
% opts.sparseAlgo = 'treves-Rolls';


figure(3);clf
ax = subplot(1,1,1);
opts.ensemblesToPlot = outVars.ensemblesToUse & outVars.numCellsEachEnsBackup==10;
[outData] = plotSparsityByDist_GH(All,outVars,opts,ax);
...
[outData] = plotSparsityByDist_GH(All,outVars,opts,ax1);
...
[outData] = plotSparsityByDist_GH(All,outVars,opts,ax2);
% ylim(yrange)
...
[outData] = plotSparsityByDist_GH(All,outVars,opts,ax3);
% ylim(yrange)
...
[outData] = plotSparsityByDist_GH(All,outVars,opts,ax4);
% ylim(yrange)
