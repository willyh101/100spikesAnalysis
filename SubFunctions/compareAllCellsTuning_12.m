function [All, outVars] = compareAllCellsTuning_12(All, outVars, opts)
...
for ind = 1:numel(All)
    ...
    pref = idx2ori(All(ind).out.anal.prefOri(isVisCells), [nan 0:30:330]);
    orthos = idx2ori(All(ind).out.anal.orthoOri(:, isVisCells), [nan 0:30:330]);
