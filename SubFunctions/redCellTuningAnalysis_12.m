function [All, outVars] = redCellTuningAnalysis_12(All, outVars, opts)
...
for ind = 1:numel(All)
    ...
    % real ori
    redTuningOri = idx2ori(redTuningIdx, [nan 0:30:330]); % actual oris
    ...
    % ori
    notRedTuningOri = idx2ori(notRedTuningIdx, [nan 0:30:330]);
