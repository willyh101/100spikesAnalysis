 function [All, outVars] = meanMatrixVisandCorr_GH(All,opts,outVars);
...
%     All(ind).out.anal.pVisR = pVisR;
    ...
    clear minDistbyHolo geoDistbyHolo meanDistbyHolo harmDistbyHolo centerDistbyHolo
...
%                 distBins = [0:25:1000]; %moved up
       ...
       All(ind).out.anal.minDistbyHolo = minDistbyHolo;
        ...
        All(ind).out.anal.centerDistbyHolo = centerDistbyHolo;
