function plotDistByClosestTargetOri(All,outVars,opts)
...
% 
    ...
    if ensemblesToUse(i)
        ...
        allDist = All(ind).out.anal.allDistance(htg,:); 
        [X closestTarget] = min(allDist); 
        closestTarget=htg(closestTarget);
        closestTargetPO = cellOris(closestTarget); 
        
%         cellOrisDiff = abs(cellOris-outVars.ensPO(i));
        cellOrisDiff = abs(cellOris-closestTargetPO);
