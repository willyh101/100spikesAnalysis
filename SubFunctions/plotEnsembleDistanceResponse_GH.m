function plotEnsembleDistanceResponse_GH(outVars,figNum,plotRegression)
...
ensCenterD = outVars.ensCenterD;
ensCenterV = outVars.ensCenterV;
...
dat = {ensMeaD(ensemblesToUse), ...
    ensMaxD(ensemblesToUse), ensCenterD(ensemblesToUse) ensCenterV(ensemblesToUse)};
names = {'Mean' 'Max' 'Center Ave' 'Center Var'};

% dat = {ensMeaD(ensemblesToUse), ensGeoD(ensemblesToUse),...
%     ensMaxD(ensemblesToUse),  ensMinD(ensemblesToUse) ensCenterD(ensemblesToUse) ensCenterV(ensemblesToUse)};
% names = {'Mean' 'GeoMean' 'Max' 'Min' 'Center Ave' 'Center Var'};
